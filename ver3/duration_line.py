...
if final_task == 0:
    with open("send_command_to_balabolka.py", "r", encoding="utf-8") as f:
        print(f"Значение переменной final_task: {final_task}")
        print("Запуск файла send_command_to_balabolka.py...")
        exec(f.read())
else:
    print("Запуск send_command_to_balabolka.py отменён")