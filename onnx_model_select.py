...
mapping = {
    ...
    "Language: ca": "ca_ES-upc_ona-medium", #Catalan Spain Каталонский Испания
    ...
    "Language: nl": "nl_NL-mls-medium", #Dutch Netherlands Нидерландский Нидерланды 
    ...
    "Language: ro": "ro_RO-mihai-medium", #Romanian Romania Румынский 
    ...
    "Language: sw": "sw_CD-lanfrica-medium", #Swahili Democratic Republic of the Congo Суахили Демократическая 
